...
// 1. Check AGENTS.md exists and is within word count cap (< 1500 words)
...
if (wordCount > 1500) {
  console.error(`❌ [RULE VIOLATION] AGENTS.md exceeds 1,500 word cap (${wordCount} words). Prune volatile facts before audit.`);
  process.exit(1);
}

// 2. Check Static Analysis & Lint
try {
